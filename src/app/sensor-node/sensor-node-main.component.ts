...
export class SensorNodeMainComponent implements OnInit {
  ...
  getMicrocontrollerData() {
    ...
    this.sensorNodeService.getMicrocontrollersFromBackend().subscribe(
      (response: Response) => {
  ...
  getSensorData() {
    this.sensorNodeService.getSensorsFromBackend().subscribe(
      (response: Response) => {
        const data = response.json();
        console.log(data);
        for (let m of data) {
  ...
  getSensorNodeData() {
    this.sensorNodeService.getSensorNodesFromBackend().subscribe(
      (response: Response) => {
        const data = response.json();
        console.log(data);
        for (let m of data) {
  ...
  getCommunicationData() {
    this.sensorNodeService.getCommunicationTypesFromBackend().subscribe(
      (response: Response) => {
        const data = response.json();
        console.log(data);
        for (let m of data) {
